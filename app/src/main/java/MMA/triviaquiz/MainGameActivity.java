...
public class MainGameActivity extends AppCompatActivity {
    FancyButton buttonB, buttonC, buttonD;
    FancyButton buttonA;
    TextView questionText, triviaQuizText, timeText, resultText, coinText,cat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String rec = b.getString("key");

        //Initializing variables
        questionText = (TextView) findViewById(R.id.triviaQuestion);
        buttonA = (FancyButton) findViewById(R.id.buttonA);
        buttonB = (FancyButton) findViewById(R.id.buttonB);
        buttonC = (FancyButton) findViewById(R.id.buttonC);
        buttonD = (FancyButton) findViewById(R.id.buttonD);
        ...
        sb = Typeface.createFromAsset(getAssets(), "fonts/lemon_milk.otf");
        q = Typeface.createFromAsset(getAssets(), "fonts/raleway_light.ttf");
        triviaQuizText.setTypeface(sb);
        questionText.setTypeface(tb);
        //buttonA.setTypeface(q);
        //buttonA.setRadius(17);
       /* buttonB.setTypeface(tb);
        buttonC.setTypeface(tb);
        buttonD.setTypeface(tb);*/
       // buttonA.setCustomIconFont(q);
        timeText.setTypeface(tb);
        resultText.setTypeface(sb);
        coinText.setTypeface(tb);
        cat.setTypeface(sb);
        buttonA.setCustomIconFont("res/font/raleway_light.ttf");
        ...
        if(rec.equalsIgnoreCase("nrg"))
        {list = triviaQuizHelper.getNRGQuestions();}
        else
        if(rec.equalsIgnoreCase("health"))
        {list = triviaQuizHelper.getHealthQuestions();}
        else
        if(rec.equalsIgnoreCase("edu"))
        {list = triviaQuizHelper.getEduQuestions();}
    ...
    public void updateQueAndOptions() {
        ...
        Log.e("cat",currentQuestion.getCat()+"");
        Log.e("info",currentQuestion.getinfo()+"");
        cat.setText(currentQuestion.getCat());
    ...
    public void buttonA(View view) {
        ...
        if (currentQuestion.getOptA().equals(currentQuestion.getAnswer())) {
           // buttonA.setBorderColor(R.color.lightGreen);
    ...
    public void correctDialog() {
        ...
        FancyButton buttonNext = (FancyButton) dialogCorrect.findViewById(R.id.dialogNext);

        //Setting type faces
       // correctText.setTypeface(sb);
      // buttonNext.setTypeface(sb);
        correctText.setText(currentQuestion.getinfo()+"");
